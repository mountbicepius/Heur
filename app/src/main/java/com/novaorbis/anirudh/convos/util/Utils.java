...
package com.novaorbis.anirudh.convos.util;

import android.annotation.TargetApi;
import android.os.Build;
import android.os.StrictMode;

import com.novaorbis.anirudh.convos.ContactDetailActivity;
import com.novaorbis.anirudh.convos.TalksActivity;
    ...
    public static void enableStrictMode() {
        ...
        if (Utils.hasGingerbread()) {
            ...
            if (Utils.hasHoneycomb()) {
                ...
                vmPolicyBuilder
                        .setClassInstanceLimit(TalksActivity.class, 1)
